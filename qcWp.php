<?PHP
  ...
  abstract class qcWp {
    ...
    public function wpLinkPost ($post, $frontend = null) {
      ...
      // Return the HTML
      return '<a href="' . $url . '">' . (isset ($_REQUEST ['wp-worthy-demo']) ? 'Lorem ipsum' : $postTitle) . (!$frontend ? ' (' . $postID . ')' : '') . '</a>';
    }
    // }}}
     ...
     * 
     * @param string $Name
     * @param bool $Global (optional) Return a name that is valid accross multisite-sites
     * 
     * @access protected
     * @return string
     **/
    public function getTablename ($Name, $Global = false) {
